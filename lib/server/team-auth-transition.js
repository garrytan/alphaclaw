...
const { fireAndForgetNotify } = require("./notification-policy");
const fs = require("fs");
...
const enableTeamMode = async ({
  ...
  fireAndForgetNotify(
    notify,
    `⚠️ Team mode enable failed (${String(probe.error).slice(0, 160)}) — the previous gateway auth was restored automatically.`,
