...
const kTelegramDeterministicForbiddenPattern =
  /blocked|kicked|deactivated|chat not found|user is deactivated/i;
...
// is dead (400 "chat not found"), or even the plain-text resend was rejected
// as unparseable (400 parse error AFTER the format fallback).
