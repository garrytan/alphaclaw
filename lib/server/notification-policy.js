...
const kVerboseNotificationSites = Object.freeze([
  ...
  Object.freeze({
    file: "lib/server/watchdog.js",
    symbol: "gateway is up but not ready (once per incident)",
    kind: "literal",
  }),
  Object.freeze({
  ...
  // v0.9.81 "Back up now": the standalone backup's start and success are
  // verbose like an apply's start/restarting; its FAILURE is always delivered.
  Object.freeze({
    file: "lib/server/openclaw-channel-sync.js",
    symbol: "manual backup started",
    kind: "literal",
  }),
  Object.freeze({
    file: "lib/server/openclaw-channel-sync.js",
    symbol: "manual backup written",
    kind: "literal",
  }),
  Object.freeze({
    file: "lib/server.js",
  ...
  Object.freeze({
    ...
    symbol: "overseer verdict (verbose unless action_needed / action / critical class)",
    kind: "predicate",
  }),
  Object.freeze({
