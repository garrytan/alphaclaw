...
// The gateway-env allowlist hatches are deployment-env-only: never apply them
// from the (agent-writable) .env, at boot or at runtime, so the agent cannot
// self-grant broader gateway-child inheritance. Boot skip lives in
// bin/alphaclaw.js; this is the runtime reloadEnv skip.
