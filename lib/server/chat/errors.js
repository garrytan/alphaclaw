...
const classifyError = (error) => {
  ...
  // Gateway-specific matches FIRST: the generic "not connected" would
  // otherwise shadow them and misroute the troubleshooting copy.
  if (
    lower.includes("gateway is not connected") ||
    lower.includes("gateway disconnected") ||
