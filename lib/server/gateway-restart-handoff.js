...
// Non-consuming cache read: returns the settled result for a PID, or null
// when nothing was consumed. Never spawns the CLI. Currently a test /
// diagnostic hook only — no production caller reads the cache this way.
