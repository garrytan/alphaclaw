...
// ANSI stripping (CSI/OSC/charset/bare-ESC + cursor fragments) hoisted to
// utils/redact so the restart-evidence redaction path shares this complete
// implementation. Re-exported below — consumers of this module are unchanged.
