...
const registerServerRoutes = ({
  ...
  registerRescueLinkRoutes({
    ...
    throttle: {
      // Failed probes: 1 event / 5 min per IP, 12 / hour globally.
      ...
      // Redemptions: 1 event / min per IP (forensics stay; watchdog.db growth
      // stays bounded even if a leaked live link is hammered).
