...
const registerServerRoutes = ({
  ...
  const teamService = createTeamService({
    ...
    // Team-mode transitions restart the gateway up to twice; they must hold
    // the shared lifecycle lock like every other restart path or the
    // watchdog/user restarts race the transition (v0.9.35 merge seam).
