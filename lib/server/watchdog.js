...
const createWatchdog = ({
  ...
  // toward the existing latch/crash flows).
  ...
  // (no latch, no rollback, no crash accounting, no notification).
  ...
  // lib/server.js delegates getGatewayReadiness here. Reasons are
