  ...
  const applyUnhealthyIncumbentConflict = ({
    ...
    void notifyOncePerIncident(
      ...
      [
        ...
        withViewLogsSuffix(
          leaseHeld
            ? `🟡 The previous gateway's owner lease (${leaseHolder}) is still recorded in the state directory — the gateway will be relaunched when it lapses (about ${leaseWaitSeconds}s)`
            : stateWriter
