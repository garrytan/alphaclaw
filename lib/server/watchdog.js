    ...
    if (typeof releaseChannelHooks?.getInfo === "function") {
      ...
      if (unreadable != null) {
        logEvent(
          ...
          source,
          "skipped",
          { reason: "gateway_hold_unreadable", error: unreadable },
          correlationId,
        );
        return { ok: false, skipped: true, reason: "gateway_hold_unreadable" };
      }
      if (holdInfo?.gatewayHold) {
        logEvent(
          "repair",
          source,
          "skipped",
        ...
        return { ok: false, skipped: true, reason: "gateway_held" };
      }
    }
