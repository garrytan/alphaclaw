...
const kSeededSchemaVersions = Object.freeze({
  ...
  // 2026.9.3 (pinned v0.9.80): the first release to publish
  // `openclaw.schemaVersions` in its package.json — { state: 16, agent: 19 },
  // verified 2026-09-08 against both the metadata and the dist constants. The
  // state schema moved 15 → 16, so a 2026.9.3 → 2026.9.2 downgrade is a
  // migration-class transition (hard-gated on a verified backup).
