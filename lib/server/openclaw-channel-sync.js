...
const createOpenclawChannelSync = ({
  ...
  const applyUpdate = async ({
    ...
    const sink = ledger.createLogSink({
      operationId,
      extraSecretValues: Object.values(gatewayEnv() || {}),
    });
    activeSink = sink;
    sink.writeLine(
    ...
    try {
      ...
      // A labeled suffix (-beta.3) is a prerelease; a bare numeric suffix
      // (-2) is a hotfix above base — mirror helpers.js suffix ranking.
