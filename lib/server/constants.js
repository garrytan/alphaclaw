...
// for up to kOpenclawBootMigrationMaxTimeoutMs — the default 10-min lease
// would force-release mid-migration and let a queued restart/repair launch
// the gateway against half-migrated DBs. Boot and reconcile-retry acquire
// with this lease instead (migration ceiling + margin).
const kOpenclawReconcileLifecycleLeaseMs =
  kOpenclawBootMigrationMaxTimeoutMs + 5 * 60 * 1000;
...
// Notification outbox: delivery retries stop after this many attempts.
const kNotifyOutboxMaxAttempts = 5;
