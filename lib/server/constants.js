...
// listeners + ≤2 s handle drain), the usable check, the prune, and the
// relaunch's ready budget. Without the reserve the lease force-releases
// mid-copy and a queued gateway operation lands on a paused state dir.
