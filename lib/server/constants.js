...
if (kGatewayRestartReadyTimeoutRawSeconds * 1000 !== kGatewayRestartReadyTimeoutMs) {
  console.warn(
    `[alphaclaw] GATEWAY_RESTART_READY_TIMEOUT=${process.env.GATEWAY_RESTART_READY_TIMEOUT} clamped to ${kGatewayRestartReadyTimeoutMs / 1000}s (valid range 30-480)`,
  );
}
...
// restore is the documented recovery). workspace/ is a managed EMPTY cwd so
