...
const kOpenclawStateDbQuietMaxMs =
  kOpenclawBackupQuiesceTimeoutMs + kOpenclawBackupOfflineCopyBudgetMs + 2 * 60 * 1000;
// Consented backup reuse: a verified archive at most this old, re-verified
// (gzip -t + manifest + sha256) within this budget; the archive a migrating
// run recorded stays pinned against keep-N pruning for this long.
