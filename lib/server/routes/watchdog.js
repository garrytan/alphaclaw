...
const { kGatewayHoldCopy, kAutoRepairPauseCopy } = require("../gateway-state");
      ...
      if (
        ...
        res.status(409).json({
          ...
          error: unreadable
            ...
            : kGatewayHoldCopy.repairRefusal,
          hint: unreadable ? kGatewayHoldCopy.unreadableHint : kGatewayHoldCopy.hint,
          result,
        });
        return;
      }
