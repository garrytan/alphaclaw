...
// Forwarded-evidence headers: shared single source in proxy-identity.js — the
// webhook/oauth path strips the same list.
const { kForwardedEvidenceHeaders } = require("../proxy-identity");
