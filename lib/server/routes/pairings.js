...
const registerPairingRoutes = ({
  ...
  // Was 1000ms: with the UI polling every 3s, an idle instance spawned one
  // openclaw CLI (a full Node process) per channel per second, forever.
  const kEmptyPairingCacheTtlMs = 10000;
  const {
