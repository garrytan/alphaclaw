...
// Connect-info base URL: the shared public-origin resolver (fix wave PR 8a).
// Same precedence as before — configured URL, Railway domain, request — but
// forwarded headers count only from a trusted proxy hop.
const resolveSetupUiBaseUrl = (req) => resolvePublicOrigin(req);
