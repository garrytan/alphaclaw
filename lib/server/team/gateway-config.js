...
// Scope names come from the beta's trusted-proxy docs. deviceAutoApprove
// never carries operator.admin (upstream CRITICAL audit finding) — admin
// authority flows only through identityScopes.
const kDeviceAutoApproveScopes = Object.freeze(["read", "write", "approvals"]);
const kMemberScopes = Object.freeze(["read", "write", "approvals"]);
const kAdminScopes = Object.freeze(["read", "write", "approvals", "operator.admin"]);
