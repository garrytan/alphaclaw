...
module.exports = {
  ...
  classifyFromClawCmd,
  // Shared findings-payload validator (#87): the watchdog advisory helper
  // re-parses collector stdout through THIS predicate instead of growing a
  // second scanner (imports only utils/json — safe for hot-path callers).
