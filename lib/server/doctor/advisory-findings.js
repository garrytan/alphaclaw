...
// stripped, secret values redacted, 200-char surrogate-safe cap, one line).
// Nothing here restarts, repairs, or notifies — the watchdog logs the finding
// as advisory evidence only.
const { extractFindingsPayload } = require("./classify-doctor-cli");
const { kStructuralCheckIdPattern } = require("./constants");
const { createDoctorTextSanitizer } = require("./sanitize");

const kAdvisoryMessageMaxChars = 200;
