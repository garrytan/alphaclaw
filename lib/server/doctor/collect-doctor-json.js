...
const createDoctorJsonCollector = ({
  ...
  // failure OR on personal-budget expiry; spawnStartedAtMs always describes
  // the spawn this caller was attached to.
  const collectWithMeta = async ({ timeoutMs = null } = {}) => {
    ...
    try {
      ...
      return { stdout: winner.stdout, spawnStartedAtMs };
    } finally {
