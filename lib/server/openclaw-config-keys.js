...
const kProtectedKeyPathPrefixes = [
  ...
  // Listener exposure: a spoofed stderr blame line must never be able to
  // change where the gateway listens or whether TLS fronts it — removal can
  // flip mode/bind/port/tls back to defaults the operator never consented to.
  "gateway.mode",
  "gateway.bind",
  "gateway.port",
  "gateway.tls",
