...
// spaces) is what keeps "failed to acquire" from over-matching.
const kStateLeasePattern =
  /SQLite transaction lock wait failed|OPENCLAW_STATE_LEASE_(?:LOST|TIMEOUT|STORAGE_FAILED)|\b\S+\/\S+ was lost\b|timed out waiting for \S+ \S+\/\S+|failed to acquire \S+ \S+\/\S+/i;
