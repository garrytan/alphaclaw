...
const toGatewayRequestHeaders = ({ reqHeaders, contentLength, authorization }) => {
  ...
  // Do not pass client-supplied forwarding/identity headers to the gateway
  // (proxy_attribution_required guard + identity spoof guard). See
  // lib/server/utils/forwarded-headers.js.
