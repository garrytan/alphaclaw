...
module.exports = {
  ...
  ops: [
    ...
    },
    {
      ...
      notes:
        'clientSecret is masked to "••• (set)" for the agent actor — use hasCredentials to check setup state.',
    },
    {
    ...
    },
    {
      ...
      notes:
        "Revokes the Google refresh token and deletes local auth — reconnecting needs a human OAuth consent in the Setup UI.",
    },
  ],
};
