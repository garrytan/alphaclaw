...
// login OAuth URL have no reason to enter an agent transcript (least
// privilege — the URL is claude.ai-account-gated, so this is hygiene, not a
// security boundary), and error tails / warnings can carry arbitrary box
// content scraped from the rescue terminal.
  ...
  ops: [
    {
      ...
      notes:
        "The local block's sessionUrl, login.oauthUrl, error tail, and warnings are stripped for the agent actor.",
    },
    {
