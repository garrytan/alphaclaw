...
module.exports = {
  ...
  ops: [
    ...
    },
    {
      ...
      title: "Retry the held settings migration (optionally stripping blamed keys)",
      method: "POST",
      ...
      hint:
        "Only meaningful while updates.channel reports a gatewayHold. On success the gateway relaunches — the agent's own session may drop.",
      notes:
