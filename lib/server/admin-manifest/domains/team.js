...
module.exports = {
  ...
  ops: [
    ...
    },
    {
      ...
      hint: "The auth-mode transition restarts the gateway — the agent's own session may drop mid-call. A failed post-restart probe auto-restores the previous auth config.",
    },
    {
      id: "team.disable",
      ...
      idempotent: false,
      readOp: "team.status",
      hint: "Restores the previous gateway auth and restarts; every member session is invalidated. 409 not_enabled if team mode is already off.",
    },
    {
