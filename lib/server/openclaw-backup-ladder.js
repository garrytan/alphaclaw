...
const kDefaultBackupBudget = Object.freeze({
  ...
  // v0.9.81 (D15): the upstream rung's inactivity window (no output, no
  // staging bytes) — see kOpenclawBackupUpstreamInactivityMs. Not an
  // envelope term: it can only END an attempt earlier than cliTimeoutMs.
