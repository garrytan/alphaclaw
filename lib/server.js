...
const watchdog = createWatchdog({
  ...
  // Pre-OOM mitigation (opt-in via watchdog.memory.autoRestart). The reload-
  // wrapped restart is lock-free itself — serialization is caller-owned and
  // the watchdog tryAcquires the lifecycle lock before calling this.
  restartGatewayForMitigation: () => restartGateway(),
