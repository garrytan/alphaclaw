...
const {
  ...
  // Optional: the persisted stop evidence the offline copy records as
  // exclusivity proof (lands with the gateway stop/restart honesty work; the
  // seam below tolerates its absence).
