...
// is gated on supportsFeature("sqliteBackup"); the per-database (global +
// every configured agent) create -> parse snapshotPath -> verify sequencing
// and its honest-failure contract live in routes/openclaw-channel.js next to
// the route contract that consumes it. openclawDir feeds the agent roster
// read (openclaw.json), not the snapshot destination.
const {
