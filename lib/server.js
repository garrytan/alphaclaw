...
// resource autotune active the limits scale by memory tier instead (both
// endpoints are authenticated and rate-limited, bounding concurrent-request
// memory); parsers are built at module load, so a mid-run settings change
// shows as pending an ALPHACLAW restart in the autotune ledger.
