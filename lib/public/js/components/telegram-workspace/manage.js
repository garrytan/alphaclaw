                                ...
                                <td class="px-3 py-2 text-body">
                                  <div class="flex items-center gap-2 flex-wrap">
                                    ...
                                    html`<${TooltipBadge}
                                      tone="warning"
                                      label="stale"
                                      text="Not seen in the latest sync — the topic may have been renamed or deleted in Telegram. Use the row's verify action to check reachability."
                                    />`}
                                    ${rowModel?.unattributed &&
                                    html`<${TooltipBadge}
                                      tone="warning"
                                      label="no account attributed"
                                      text="No Telegram account is attributed to this topic, so replies may fail — re-run discovery or assign an account."
                                    />`}
                                    <button
                                      onclick=${() =>
                                        startRename(
                ...
                <div key=${model.threadId} class="px-3 py-2 space-y-2">
                  <div class="flex items-center gap-2 flex-wrap text-xs">
                    ...
                    html`<${TooltipBadge}
                      tone="warning"
                      label="stale"
                      text="Not seen in the latest sync — the topic may have been renamed or deleted in Telegram. Use the verify action to check reachability."
                    />`}
                    ${model.unattributed &&
                    html`<${TooltipBadge}
                      tone="warning"
