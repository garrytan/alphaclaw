...
export const Tooltip = ({
  ...
  disabled = false,
  delay = 0,
  // Optional stable id on the tooltip panel so a trigger can reference it
  // via aria-describedby (the panel only exists while open — acceptable
  // describedby semantics; the trigger's visible content stays the name).
  tooltipId = "",
}) => {
