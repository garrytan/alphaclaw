    ...
    <section class="bg-surface border border-border rounded-xl p-4 space-y-3">
      ...
      <div class="grid grid-cols-3 gap-2 text-xs">
        <div class="ac-surface-inset rounded-lg p-2">
          <div class="text-fg-muted">Model runs</div>
