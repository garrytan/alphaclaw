...
const ToolRow = ({ tool, onToggle, disabled = false }) => html`
...
const ToolSection = ({ section, toolStates, onToggle, disabled = false }) => {
...
// `disabled` locks all controls while a save is in flight — edits made during
// the save would be rebased away when the saved config is adopted.
export const AgentToolsPanel = ({ agent = {}, tools = {}, disabled = false }) => {
