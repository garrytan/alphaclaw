...
export const CreateChannelModal = ({
  ...
  // Slack progress indicators (3.1): tri-state so the default option never writes
  // a value the operator didn't choose. "on" restores emoji reactions; "off" keeps
  // the OpenClaw 2026.8 native-thread-status behavior explicitly.
  const [statusReactions, setStatusReactions] = useState("default");
  // ClickClack beta toggles (5.1) — tri-state like statusReactions.
