      ...
      return html`
        <div class="space-y-3">
          <p class="text-sm text-body">
            Team access is active and verified — the gateway already restarted
            and the change passed its health check, so there's nothing else to
            switch on. Send your first invite from the Team page.
          </p>
