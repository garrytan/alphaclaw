...
import htm from "htm";
import { resourceLevel } from "./helpers.js";
...
const barColor = (percent) => {
  ...
  if (level === "crit") return "bg-status-error";
  if (level === "warn") return "bg-status-warning";
  return "bg-cyan-400";
};
...
export const ResourceBar = ({
  ...
  <div
    ...
    aria-label=${onToggle && typeof label === "string" ? label : undefined}
