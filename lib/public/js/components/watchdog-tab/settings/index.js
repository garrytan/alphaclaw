    ...
    <div class="bg-surface border border-border rounded-xl p-4">
      ...
      <div class="flex items-center justify-between gap-3 mt-3">
        <div class="inline-flex items-center gap-2 text-xs text-fg-muted">
          <span>Verbose</span>
          <${InfoTooltip}
            text="On: every notice, including informational ones (gateway back online, health OK, update progress). Off: only problems, actions AlphaClaw took automatically, and anything needing your intervention."
          />
        </div>
        <${SavedToggle}
