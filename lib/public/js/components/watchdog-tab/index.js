...
// settings. The Gateway card owns safe-mode presentation when the server
// sends the unified state; the standalone banner survives only for old
// servers (version skew).
