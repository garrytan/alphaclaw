...
// Leading server ISO stamp — the log-writer guarantees every log line starts
// with the `\d{4}-\d{2}-\d{2}T` shape (lib/server/log-writer.js). Anchored and
// non-backtracking (fixed-width digit runs only), so pathological input can't
