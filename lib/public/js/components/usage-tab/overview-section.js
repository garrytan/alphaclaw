...
export const OverviewSection = ({
  ...
  // Initial-load placeholder is scoped to the chart canvas: the range/metric/
  // breakdown controls stay interactive from the first frame.
  const showChartLoading = summaryLoading && !summary;
      ...
      <div class="bg-surface border border-border rounded-xl p-4">
        ...
        <div class="relative" style=${{ height: "280px" }}>
          ${showChartLoading
            ? html`
                <div
                  class="absolute inset-0 flex items-center justify-center text-xs text-fg-muted"
                >
