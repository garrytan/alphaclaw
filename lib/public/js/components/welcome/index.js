                ...
                : state.isPairingStep
                  ...
                  : html`
                      <${WelcomeFormStep}
                        ...
                        vals=${state.vals}
                        hasAi=${state.hasAi}
                        detectedChannelIds=${state.detectedChannelIds}
                        setValue=${actions.setValue}
                        ...
                        codexStatusUnknown=${state.codexStatusUnknown}
                        codexStatusKnown=${state.codexStatusKnown}
                        codexDeferredSavePending=${state.codexDeferredSavePending}
                        codexStatusError=${state.codexStatusError}
                        startCodexAuth=${actions.startCodexAuth}
                        handleCodexDisconnect=${actions.handleCodexDisconnect}
                        codexDisconnecting=${state.codexDisconnecting}
