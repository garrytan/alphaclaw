...
export const WhatsNextCard = ({ channels = null, onSwitchTab = () => {} }) => {
  ...
  const rows = [
    !hasChannel && {
      ...
      body: "You're set up with the web chat. Add Telegram, Discord, Slack, or WhatsApp from the Channels card below to talk to your agent anywhere.",
    },
    {
      key: "update-channel",
