...
// Client-side mirror of the server's kAlphaclawHardeningPrefix: managed files
// get restart/regenerate advice, never "edit the file by hand".
...
export const GeneralHardeningCard = ({
  ...
  const model = buildHardeningCardModel(doctorStatus);
