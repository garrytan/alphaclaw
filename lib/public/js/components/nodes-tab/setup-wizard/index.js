...
// AlphaClaw's supported Node range — the ONE string package.json engines and
// the boot floor share (lib/node-runtime.js, dependency-free CJS bundled like
// lib/channel-boundary.js), so this copy can never drift from them.
import { kAlphaclawNodeEngines } from "../../../../../node-runtime.js";
import htm from "htm";
      ...
      ${
        state.step === 0
          ? html`
              ...
              <div class="text-xs text-fg-muted">
                Requires Node.js ${kAlphaclawNodeEngines}.
              </div>
            `
          : null
      }
