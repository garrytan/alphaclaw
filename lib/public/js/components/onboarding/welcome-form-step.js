...
const kChannelAccordionDefs = [
  ...
  // Manual token only in onboarding — fresh installs run the stable pin, and
  // the paste-code guided flow needs the 2026.8 beta (5.1).
  {
    id: "clickclack",
    title: "ClickClack",
    fieldKeys: ["CLICKCLACK_BOT_TOKEN"],
  },
];
