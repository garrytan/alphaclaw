...
export const DoctorTab = ({ isActive = false, onOpenFile = () => {} }) => {
  ...
  useEffect(() => {
    if (focusParam !== "context") return;
    if (!focusScrolledRef.current && typeof document !== "undefined") {
      const section = document.getElementById("doctor-context-section");
