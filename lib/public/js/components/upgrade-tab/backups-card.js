...
export const kBackupsCardIntro =
  "Configuration checkpoint; database data not backed up. Updates save configuration only, capped at 16 MiB total. Database snapshots are optional and may be large. Historical archives remain available with their original recovery coverage.";
export const kBackupNowLabel = "Create configuration checkpoint";
export const kBackupNowCaption =
  "May briefly pause and relaunch the gateway. Nothing is installed. A checkpoint cannot restore database data.";
    ...
    <div class="bg-surface border border-border rounded-xl p-4 space-y-3">
      <div class="flex flex-wrap items-center justify-between gap-2">
        ...
        <div class="flex flex-wrap items-center gap-3">
          ...
          />
          <${ActionButton}
            onClick=${onDatabaseSnapshot}
            tone="secondary"
            idleLabel="Create database snapshot"
            disabled=${backupNowDisabled || backupNowStarting}
          />
        </div>
      </div>
