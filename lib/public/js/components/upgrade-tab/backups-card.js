...
export const kBackupsCardIntro =
  "Archives AlphaClaw can restore from (the last 3 are kept): every update takes one first, and Back up now takes one on demand. Only verified, complete archives are reusable by a later update; the reason is on each row.";
export const kBackupNowLabel = "Back up now";
export const kBackupNowCaption =
  "Pauses the gateway for the copy (seconds to a few minutes), then relaunches it. Nothing is installed.";
