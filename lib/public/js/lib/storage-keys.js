...
// v4: rows gained replyAccountId/deliverable and reply targets for
// account-scoped/suffixed/non-telegram keys — pre-fix cached rows carry
// empty reply targets and must not ride the fast-submit window after upgrade.
export const kAgentSessionsCacheKey = "alphaclaw.agent.sessionsCache.v4";
...
// Durable send outbox (queued/inflight/failed messages survive reloads);
// capped by count AND serialized bytes in send-outbox.js.
export const kChatSendOutboxStorageKey = "alphaclaw.chat.sendOutbox";

// --- General tab "What's next" card ---
// sessionStorage: "Hide for now" is per browser SESSION (never dismiss-forever).
export const kWhatsNextHiddenForSessionKey = "alphaclaw.whatsNext.hiddenForSession";
export const kWhatsNextUpdateChannelReviewedKey = "alphaclaw.whatsNext.updateChannelReviewed";

// --- Envars ---
export const kEnvarsSecretsBannerDismissedKey = "alphaclaw.envars.secretsBannerDismissed";
