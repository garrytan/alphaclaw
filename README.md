...
upgrade evidence. Cloud sandboxes may lack Docker, and a `domain threaded`
cgroup cannot run the memory-limited autotune container. Use CI or a Docker
Desktop/Colima host for those checks. The immutable two-image journey must
pass before considering self-upgrade risk covered.
