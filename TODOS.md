...
## P3 — Notification remediation-action parity (PARTIALLY DONE, v0.9.50)
...
- **Why:** These are genuine automatic fixes that today only reach the console; the verbose/important notification work (v0.9.50) covers the server phase only.
