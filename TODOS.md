...
- **Why:** Each flagged by the /ship review army (security/performance/testing/maintainability specialists) and verified real; deferred as beyond this wave's blast radius — none is user-visible on the happy path and the risky lifecycle logic beneath them is covered (83% diff coverage, 240+ chat tests).
